...
export class Client extends ClientJS {
    ...
    async executeComponent(components, interaction, log) {
        ...
        if ((log ?? !this.silent) && !results.some((res) => res)) {
            this.logger.log(`${this.user?.username ?? this.botId} >> ${interaction.isButton() ? "button" : "select menu"} component handler not found, interactionId: ${interaction.id} | customId: ${interaction.customId}`);
        }
    }
    /**
